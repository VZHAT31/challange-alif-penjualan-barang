...
<head>
    ...
    <style>
        body {
            background: url('tumpukanbarang.jpg') no-repeat center center fixed;
...
<div class="container">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "UPDATE barang SET nama_barang='$nama_barang', persediaan='$persediaan', harga_awal='$harga_awal' WHERE kode_barang='$kode_barang'";
        $hasil = mysqli_query($kon, $sql);
